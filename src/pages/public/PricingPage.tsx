    ...
    <section className="bg-cream py-16">
      <PageContainer width="wide">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-3 font-display text-5xl text-navy">Simple, when you need it</h1>
          <p className="mt-4 text-navy-muted">
            Payments with Razorpay will be added later. These plans are placeholders for the
            product foundation.
          </p>
        </div>
        {isLoading || !data ? (
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {data.map((plan) => (
              ...
              >
                <p className={cn('text-sm', plan.highlighted ? 'text-gold' : 'text-gold-deep')}>
                  {plan.name}
                </p>
